...
import com.artifactkeeper.client.models.ReleaseTargetResponse
import com.artifactkeeper.client.models.SetReleaseTargetRequest
...
interface PromotionApi {
    ...
    /**
     * GET api/v1/promotion/repositories/{key}/release-target
     * Get the linked release target for a staging repository.
     * 
     * Responses:
     *  - 200: Release target information
     *  - 404: Repository not found
     *  - 422: Repository is not a staging repository
     *
     * @param key Staging repository key
     * @return [ReleaseTargetResponse]
     */
    @GET("api/v1/promotion/repositories/{key}/release-target")
    suspend fun getReleaseTarget(@Path("key") key: kotlin.String): Response<ReleaseTargetResponse>
    ...
    /**
     * PUT api/v1/promotion/repositories/{key}/release-target
     ...
     * Responses:
     *  - 200: Release target updated
     *  - 404: Repository not found
     *  - 422: Validation error
     *
     * @param key Staging repository key
     * @param setReleaseTargetRequest 
     * @return [ReleaseTargetResponse]
     */
    @PUT("api/v1/promotion/repositories/{key}/release-target")
    suspend fun setReleaseTarget(@Path("key") key: kotlin.String, @Body setReleaseTargetRequest: SetReleaseTargetRequest): Response<ReleaseTargetResponse>

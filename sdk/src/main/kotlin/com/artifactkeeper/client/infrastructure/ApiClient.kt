package com.artifactkeeper.client.infrastructure

import com.artifactkeeper.client.auth.HttpBearerAuth
...
import com.artifactkeeper.client.infrastructure.Serializer.kotlinxSerializationJson
...
class ApiClient(
    ...
    constructor(
        ...
        authNames.forEach { authName ->
            val auth: Interceptor? = when (authName) { 
                "bearer_auth" -> HttpBearerAuth("bearer")
    ...
    companion object {
        protected const val BASE_URL_KEY: String = "com.artifactkeeper.client.baseUrl"
        @Deprecated(
